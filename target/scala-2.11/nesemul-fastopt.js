...
$c_Ltutorial_webapp_HelloWorldApp$.prototype = new $h_O();
$c_Ltutorial_webapp_HelloWorldApp$.prototype.constructor = $c_Ltutorial_webapp_HelloWorldApp$;
/** @constructor */
function $h_Ltutorial_webapp_HelloWorldApp$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_HelloWorldApp$.prototype = $c_Ltutorial_webapp_HelloWorldApp$.prototype;
$c_Ltutorial_webapp_HelloWorldApp$.prototype.init___ = (function() {
  return this
});
$c_Ltutorial_webapp_HelloWorldApp$.prototype.main__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)((function() {
    $m_Ltutorial_webapp_HelloWorldApp$().setupUI__V()
  }))
});
$c_Ltutorial_webapp_HelloWorldApp$.prototype.setupUI__V = (function() {
  ...
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("#click-me-button").click((function() {
    $m_Ltutorial_webapp_HelloWorldApp$().addClickedMessage__V()
  }))
});
$c_Ltutorial_webapp_HelloWorldApp$.prototype.addClickedMessage__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body").append("<p>You clicked the button!</p>")
});
$c_Ltutorial_webapp_HelloWorldApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Ltutorial_webapp_HelloWorldApp$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Ltutorial_webapp_HelloWorldApp$ = new $TypeData().initClass({
  Ltutorial_webapp_HelloWorldApp$: 0
}, false, "tutorial.webapp.HelloWorldApp$", {
  Ltutorial_webapp_HelloWorldApp$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Ltutorial_webapp_HelloWorldApp$.prototype.$classData = $d_Ltutorial_webapp_HelloWorldApp$;
var $n_Ltutorial_webapp_HelloWorldApp$ = (void 0);
function $m_Ltutorial_webapp_HelloWorldApp$() {
  if ((!$n_Ltutorial_webapp_HelloWorldApp$)) {
    $n_Ltutorial_webapp_HelloWorldApp$ = new $c_Ltutorial_webapp_HelloWorldApp$().init___()
  };
  return $n_Ltutorial_webapp_HelloWorldApp$
}
$e.tutorial = ($e.tutorial || {});
$e.tutorial.webapp = ($e.tutorial.webapp || {});
$e.tutorial.webapp.HelloWorldApp = $m_Ltutorial_webapp_HelloWorldApp$;
/** @constructor */
...
//# sourceMappingURL=nesemul-fastopt.js.map
